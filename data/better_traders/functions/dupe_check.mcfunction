...
execute store success score @s BT.TradeSuccess run data modify storage better_traders:trader_offers Offer0 set from entity @s Offers.Recipes[6]
execute if score @s BT.TradeSuccess matches 1 run data modify storage better_traders:trader_offers Offer0 set from entity @s Offers.Recipes[0]
execute if score @s BT.TradeSuccess matches 0 run function better_traders:roll6

execute store success score @s BT.TradeSuccess run data modify storage better_traders:trader_offers Offer1 set from entity @s Offers.Recipes[6]
execute if score @s BT.TradeSuccess matches 1 run data modify storage better_traders:trader_offers Offer1 set from entity @s Offers.Recipes[1]
execute if score @s BT.TradeSuccess matches 0 run function better_traders:roll6

execute store success score @s BT.TradeSuccess run data modify storage better_traders:trader_offers Offer2 set from entity @s Offers.Recipes[6]
execute if score @s BT.TradeSuccess matches 1 run data modify storage better_traders:trader_offers Offer2 set from entity @s Offers.Recipes[2]
execute if score @s BT.TradeSuccess matches 0 run function better_traders:roll6

execute store success score @s BT.TradeSuccess run data modify storage better_traders:trader_offers Offer3 set from entity @s Offers.Recipes[6]
execute if score @s BT.TradeSuccess matches 1 run data modify storage better_traders:trader_offers Offer3 set from entity @s Offers.Recipes[3]
execute if score @s BT.TradeSuccess matches 0 run function better_traders:roll6

execute store success score @s BT.TradeSuccess run data modify storage better_traders:trader_offers Offer4 set from entity @s Offers.Recipes[6]
execute if score @s BT.TradeSuccess matches 1 run data modify storage better_traders:trader_offers Offer4 set from entity @s Offers.Recipes[4]
execute if score @s BT.TradeSuccess matches 0 run function better_traders:roll6

execute store success score @s BT.TradeSuccess run data modify storage better_traders:trader_offers Offer4 set from entity @s Offers.Recipes[6]
execute if score @s BT.TradeSuccess matches 1 run data modify storage better_traders:trader_offers Offer4 set from entity @s Offers.Recipes[5]
execute if score @s BT.TradeSuccess matches 0 run function better_traders:roll6

data modify storage better_traders:trader_offers Offer4 set from entity @s Offers.Recipes[6]
